...
#Objetivo: Obtener las estadísticas de los grafos creados a partir de la DB de Yamanishi IC.
...
YIC_PATH = '/home/oazurmendis/data/jfuente/DTI/Input4Models/DB/Data/Yamanashi_et_al_GoldStandard/IC/interactions/ic_admat_dgc_mat_2_line.txt'

# load dtis 
DTI = np.loadtxt(YIC_PATH, dtype='str')
...
ax.set_title("YAMANISHI IC DTI Network", font)
font["color"] = "b"
ax.text(
    0.80,
    0.10,
...
#plt.savefig(f'Yamanishi_IC.png')
...
nx.draw(subg,
        node_size=15,
        node_color=colors)
#plt.savefig(f'YamIC/sub_{n}.png')
...
fig.show()
#plt.savefig('Yamanishi-IC-Degree-nueva.png')
...
fig.show()
#plt.savefig('Yamanishi-IC-Connectivity-nueva.png')
