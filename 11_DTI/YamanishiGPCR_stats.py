...
#Objetivo: Obtener las estadísticas de los grafos creados a partir de la DB de Yamanishi GPCR.
...
YGPCR_PATH = '/home/oazurmendis/data/jfuente/DTI/Input4Models/DB/Data/Yamanashi_et_al_GoldStandard/GPCR/interactions/gpcr_admat_dgc_mat_2_line.txt'

# load dtis 
DTI = np.loadtxt(YGPCR_PATH, dtype='str')
...
ax.set_title("YAMANISHI GPCR DTI Network", font)
font["color"] = "b"
ax.text(
    0.80,
    0.10,
...
#plt.savefig(f'Yamanishi_GPCR.png')
...
nx.draw(subg,
        node_size=15,
        node_color=colors)
#plt.savefig(f'YamGPCR/sub_{n}.png')

# Nodos isolados
list(nx.isolates(G))

# Grafica de los grados
...
fig.show()
plt.savefig('Yamanishi-GPCR-Degree-nueva.png')
...
#Grafica de los nodos por componente
...
fig.show()
plt.savefig('Yamanishi-GPCR-Connectivity-nueva.png')
