...
#Objetivo: Obtener las estadísticas de los grafos creados a partir de la DB de Yamanishi NR.
...
# load dtis 
DTI = np.loadtxt(NR_PATH, dtype='str')
...
ax.set_title("Yamanishi NR DTI Network", font)
font["color"] = "b"
ax.text(
    0.80,
    0.10,
...
#plt.savefig(f'Yamanishi_NR.png')
...
fig.show()
#plt.savefig('Yamanishi-NR-Degree-nueva.png')
...
fig.show()
#plt.savefig('Yamanishi-NR-Connectivit-nueva.png')
