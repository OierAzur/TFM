...
#Objetivo: Análisis de las dianas regulatorias encontradas en los conjuntos de genes.
...
#MsigDb data
load("/Users/oierazur/TFM/GeneSet/human_c3_v5p2.rdata")

#CCARag

idx <- ids2indices(Hs.c3,id=CCARag_vs_normal_ortolog$human_entrez)
...
save(cam.CCARagsNormal,file="RegGS_GENESET_CCARag.Rdata")
write.csv(x=cam.CCARagsNormal,"RegGS_GENESET_CCARag.csv")
save(cam.CCARagsNormal,file="RegGS_GENESET_CCARag_UP.Rdata")
write.csv(x=cam.CCARagsNormal,"RegGS_GENESET_CCARag_UP.csv")
save(cam.CCARagsNormal,file="RegGS_GENESET_CCARag_Down.Rdata")
write.csv(x=cam.CCARagsNormal,"RegGS_GENESET_CCARag_Down.csv")

#Dieta

idx <- ids2indices(Hs.c3,id=Dieta_vs_normal_ortolog$human_entrez)
...
save(cam.Dieta_vs_normal,file="RegGS_GENESET_DIETA.Rdata")
write.csv(x=cam.Dieta_vs_normal,"RegGS_GENESET_DIETA.csv")
save(cam.Dieta_vs_normal_UP,file="RegGS_GENESET_DIETA_UP.Rdata")
write.csv(x=cam.Dieta_vs_normal_UP,"RegGS_GENESET_DIETA_UP.csv")
save(cam.Dieta_vs_normal_Down,file="RegGS_GENESET_DIETA_Down.Rdata")
write.csv(x=cam.Dieta_vs_normal_Down,"RegGS_GENESET_DIETA_Down.csv")


#Hidrodinamica

idx <- ids2indices(Hs.c3,id=Hidrodinamica_vs_normal_ortolog$human_entrez)
...
save(cam.Hidrodinamica_vs_normal,file="RegGS_GENESET_HIDRODINAMICA.Rdata")
write.csv(x=cam.Dieta_vs_normal,"RegGS_GENESET_HIDRODINAMICA.csv")
save(cam.Hidrodinamica_vs_normal_UP ,file="RegGS_GENESET_HIDRODINAMICA_UP.Rdata")
write.csv(x=cam.Dieta_vs_normal_UP,"RegGS_GENESET_HIDRODINAMICA_UP.csv")
save(cam.Hidrodinamica_vs_normal_Down,file="RegGS_GENESET_HIDRODINAMICA_Down.Rdata")
write.csv(x=cam.Dieta_vs_normal_Down,"RegGS_GENESET_HIDRODINAMICA_Down.csv")

#Transformados

idx <- ids2indices(Hs.c3,id=Transformados_vs_normal_ortolog$human_entrez)
...
save(cam.Transformadas_vs_normal,file="RegGS_GENESET_TRANSFORMADAS.Rdata")
write.csv(x=cam.Transformadas_vs_normal,"RegGS_GENESET_TRANSFORMADAS.csv")
save(cam.Transformadas_vs_normal_UP,file="RegGS_GENESET_TRANSFORMADAS_UP.Rdata")
write.csv(x=cam.Transformadas_vs_normal_UP,"RegGS_GENESET_TRANSFORMADAS_UP.csv")
save(cam.Transformadas_vs_normal_Down,file="RegGS_GENESET_TRANSFORMADAS_Down.Rdata")
write.csv(x=cam.Transformadas_vs_normal_Down,"RegGS_GENESET_TRANSFORMADAS_Down.csv")

#Dieta Vs hidrodinamica

idx <- ids2indices(Hs.c3,id=DietaVsHidro_ortolog$human_entrez)
...
save(cam.DietaVsHidro,file="RegGS_GENESET_DietVsHidro.Rdata")
write.csv(x=cam.DietaVsHidro,"RegGS_GENESET_DietVsHidro.csv")
save(cam.DietaVsHidro_UP,file="RegGS_GENESET_DietVsHidro_UP.Rdata")
write.csv(x=cam.DietaVsHidro_UP,"RegGS_GENESET_DietVsHidro_UP.csv")
save(cam.DietaVsHidro_Down,file="RegGS_GENESET_DietVsHidro_Down.Rdata")
write.csv(x=cam.DietaVsHidro_Down,"RegGS_GENESET_DietVsHidro_Down.csv")
