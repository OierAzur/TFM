...
#Objetivo: Análisis de los inmunologic signatures de estos conjuntos de genes.

######################################################################################################
setwd("Documents/TFM/GeneSet/InmunoSig")
...
#MsigDb data
load("/Users/oierazur/TFM/GeneSet/human_c7_v5p2.rdata")

#CCARag
idx <- ids2indices(Hs.c7,id=CCARag_vs_normal_ortolog$human_entrez)
...
save(cam.CCARagsNormal,file="InmunoSig_GENESET_CCARag.Rdata")
write.csv(x=cam.CCARagsNormal,"InmunoSig_GENESET_CCARag.csv")
save(cam.CCARagsNormal,file="InmunoSig_GENESET_CCARag_UP.Rdata")
write.csv(x=cam.CCARagsNormal,"InmunoSig_GENESET_CCARag_UP.csv")
save(cam.CCARagsNormal,file="InmunoSig_GENESET_CCARag_Down.Rdata")
write.csv(x=cam.CCARagsNormal,"InmunoSig_GENESET_CCARag_Down.csv")
...
save(cam.Dieta_vs_normal,file="InmunoSig_GENESET_DIETA.Rdata")
write.csv(x=cam.Dieta_vs_normal,"InmunoSig_GENESET_DIETA.csv")
save(cam.Dieta_vs_normal_UP,file="InmunoSig_GENESET_DIETA_UP.Rdata")
write.csv(x=cam.Dieta_vs_normal_UP,"InmunoSig_GENESET_DIETA_UP.csv")
save(cam.Dieta_vs_normal_Down,file="InmunoSig_GENESET_DIETA_Down.Rdata")
write.csv(x=cam.Dieta_vs_normal_Down,"InmunoSig_GENESET_DIETA_Down.csv")
...
save(cam.Hidrodinamica_vs_normal,file="InmunoSig_GENESET_HIDRODINAMICA.Rdata")
write.csv(x=cam.Dieta_vs_normal,"InmunoSig_GENESET_HIDRODINAMICA.csv")
save(cam.Hidrodinamica_vs_normal_UP ,file="InmunoSig_GENESET_HIDRODINAMICA_UP.Rdata")
write.csv(x=cam.Dieta_vs_normal_UP,"InmunoSig_GENESET_HIDRODINAMICA_UP.csv")
save(cam.Hidrodinamica_vs_normal_Down,file="InmunoSig_GENESET_HIDRODINAMICA_Down.Rdata")
write.csv(x=cam.Dieta_vs_normal_Down,"InmunoSig_GENESET_HIDRODINAMICA_Down.csv")
...
save(cam.Transformadas_vs_normal,file="InmunoSig_GENESET_TRANSFORMADAS.Rdata")
write.csv(x=cam.Transformadas_vs_normal,"InmunoSig_GENESET_TRANSFORMADAS.csv")
save(cam.Transformadas_vs_normal_UP,file="InmunoSig_GENESET_TRANSFORMADAS_UP.Rdata")
write.csv(x=cam.Transformadas_vs_normal_UP,"InmunoSig_GENESET_TRANSFORMADAS_UP.csv")
save(cam.Transformadas_vs_normal_Down,file="InmunoSig_GENESET_TRANSFORMADAS_Down.Rdata")
write.csv(x=cam.Transformadas_vs_normal_Down,"InmunoSig_GENESET_TRANSFORMADAS_Down.csv")
...
save(cam.DietaVsHidro,file="InmunoSig_GENESET_DietVsHidro.Rdata")
write.csv(x=cam.DietaVsHidro,"InmunoSig_GENESET_DietVsHidro.csv")
save(cam.DietaVsHidro_UP,file="InmunoSig_GENESET_DietVsHidro_UP.Rdata")
write.csv(x=cam.DietaVsHidro_UP,"InmunoSig_GENESET_DietVsHidro_UP.csv")
save(cam.DietaVsHidro_Down,file="InmunoSig_GENESET_DietVsHidro_Down.Rdata")
write.csv(x=cam.DietaVsHidro_Down,"InmunoSig_GENESET_DietVsHidro_Down.csv")
